      ...
      builder: (controller) => Container(
        decoration: BoxDecoration(
          color: !controller.internetConnection ||
              ...
              ? Colors.white // White background for error/loading states
              : null,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    auspiSevenData(
                                        ...
                                        "${controller.CRashi}",
                                        "Nakshatra",
                                        "${controller.CNkh} ${controller.Nakshatra_endtime}",
                                        "MoonRise",
                                        "${controller.MoonRise}",
                                        "Moonset",
                                        "${controller.MoonSet}",
                                        "Yog",
                                        "${controller.Yog_endtime}",
                                        "Moon Month",
                                        "${controller.Hindu_month}",
                                        "Moon Tithi",
                                        "${controller.MoonTithi} ${controller.Tithi_endtime}",
                                        "Tithi Karan",
                                        "${controller.KaranText} ${controller.Karan_endtime}",
                                        "Agni",
                                        "${controller.AgniText}"),
                                    SizedBox(
